...
ALTER TABLE company_addresses DROP CONSTRAINT fk_company_addresses_company_id_companies_id;
ALTER TABLE company_addresses DROP CONSTRAINT fk_company_addresses_address_id_addresses_id;
